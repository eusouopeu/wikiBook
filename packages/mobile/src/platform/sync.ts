...
import { listArticles as listAllArticles, writeArticleRaw } from "./articles";
...
export async function runSync(serverUrl: string, token: string): Promise<{ pushed: number; pulled: number; totalArticles: number }> {
